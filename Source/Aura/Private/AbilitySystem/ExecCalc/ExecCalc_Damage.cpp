...
void UExecCalc_Damage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	// Capture Armor and ArmorPenetration
	...
	// Source's ArmorPenetration ignores a percentage of Target's Armor
	...
	// Capture Critical Hit Chance and Damage on Source, and Critical Hit Resistance on Target
	...
	// Critical Hit Resistance ignores a percentage of Critical Hit Chance
	const float EffectiveCriticalHitChance = SourceCriticalHitChance - TargetCriticalHitResistance * CriticalHitResistanceCoefficient;

	// If Critical, double the damage plus Critical Hit Damage
